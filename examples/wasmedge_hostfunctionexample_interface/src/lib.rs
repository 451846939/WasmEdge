...
pub mod wasmedge_hostfunction_climbstairs {
    use std::os::raw::c_char;
    #[link(wasm_import_module = "host_function_climbstairs")]
    extern "C" {
        pub fn host_function_set_step_number(cid: i32);
        pub fn host_function_start_climb_stairs() -> i32;
        pub fn host_function_climb_stairs_print();
    }
}

pub fn set_step_number(cid: i32) {
    unsafe {
        wasmedge_hostfunction_climbstairs::host_function_set_step_number(cid);
    }
}

pub fn start_climb_stairs()->i32 {
    let res : i32;
    unsafe {
        res = wasmedge_hostfunction_climbstairs::host_function_start_climb_stairs();
    }
    res
}


pub fn climb_stairs_print() {
    unsafe {
        wasmedge_hostfunction_climbstairs::host_function_climb_stairs_print();
    }
}